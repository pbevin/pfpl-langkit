...
const getLoaders = function (env) {
  ...
  if (env === productionEnvironment ) {
    ...
    loaders.push({test: /\.css$/, loader: ExtractTextPlugin.extract("css?sourceMap!postcss?sourcemap")});
  } else {
    loaders.push({test: /\.css$/, loaders: ["style", "css?sourceMap", "postcss?sourceMap"]});
  }
